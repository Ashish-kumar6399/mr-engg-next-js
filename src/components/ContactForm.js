        ...
        <div className="contact-details col-12 col-md-6 ">
          ...
          <div className="contact-s">
            ...
            <div>
              ...
              <p>
                <a
                  href="mailto:virendersingh@mrenggworks.com"
                  className="text-black   text-decoration-none"
                >
              ...
              <p>
                <a
                  href="mailto:jasvinder@mrenggworks.com"
                  className="text-black  text-decoration-none"
                >
              ...
              <p>
                <a
                  href="mailto:gaganjyotkaur@mrenggworks.com"
                  className="text-black  text-decoration-none"
                >
